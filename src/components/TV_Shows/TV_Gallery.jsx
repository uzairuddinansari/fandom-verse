...
import galleryData from "../../JSON/TV_Shows/TV_ShowsGellery.json";
import galleryImages from "../../JSON/TV_Shows/TV_ShowsGellery.js";
  ...
  const handleSaveGallery = (item) => {
    try {
      ...
      if (alreadySaved) {
        ...
        const image = getImage(item.movieName);
