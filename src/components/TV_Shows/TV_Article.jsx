...
import articleData from "../../JSON/TV_Shows/TV_Shows_article.json";
import "../../styles/ArticleGrid.css";
import articleImages from "../../JSON/TV_Shows/TV_Shows_article.js";
    ...
    <section className="article-section">
      <div className="article-container">
        ...
        <div className="article-grid">
          ...
          {articleData.tvShows.slice(0, 8).map((article, index) => {
