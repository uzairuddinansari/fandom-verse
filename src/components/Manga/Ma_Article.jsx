...
// import articleData from "../../JSON/Manga/Manga.json";
// import "../../styles/ArticleGrid.css";
// import articleImages from "../../JSON/Manga/Manga_img.js";
...
//           {articleData.manga.slice(0, 8).map((article, index) => {
